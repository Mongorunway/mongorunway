...
Mongorunway does not restrict you in choosing a migration repository. If necessary, you 
can create your own custom implementations of migration repositories for management.
